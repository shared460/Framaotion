    ...
    return(
        <motion.div className='base' animate={{background:'#ffd6ff', marginTop:'10px'}}>
            <motion.div className='container' animate={{color:'black'}}>
                <motion.p animate={{fontSize:'40px'}}>Thank you for order <motion.span animate={{textShadow:'2px 2px 2px red', background:'white', borderRadius:'30px', fontSize:'50px'}}>;)</motion.span></motion.p>
